            ...
            <div className='w-full max-w-screen-lg mt-16'>
                ...
                <section className='w-full h-auto border-2 border-white p-6 sm:p-8 md:p-10 rounded-xl flex flex-col md:flex-row items-center justify-between shadow-[5px_5px_rgba(0,_98,_90,_0.4),_10px_10px_rgba(0,_98,_90,_0.3),_15px_15px_rgba(0,_98,_90,_0.2),_20px_20px_rgba(0,_98,_90,_0.1),_25px_25px_rgba(0,_98,_90,_0.05)]'>
                    <p className='text-base sm:text-lg leading-relaxed'>
                        Hi, I&apos;m Mohith, a third-year engineering student passionate about software development and open-source contributions. I enjoy working on real-world projects, refining my coding skills, and collaborating with the developer community.
                        <br /><br />
                        📚 <strong>Education & Experience</strong> <br />
                        - third-year engineering student with a keen interest in full-stack development. <br />
                        - Actively contributed to Hacktoberfest, gaining experience in open-source collaboration. <br />
                        ...
                        - Interests: Open-source development, DSA, web applications, and scalable system design. <br /><br />
